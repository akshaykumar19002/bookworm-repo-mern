...
const Cart = () => {
  ...
  function RemoveBook(bookId, action) {
    let userId = localStorage.getItem('userId');
      fetch(process.env.REACT_APP_BACKEND_URL + "/cart/deleteBookFromCart?bookId=" + bookId+ "&action=" + action +"&userId="+
    ...
    return(<Container fluid>
      <Row>     
          <Col xs={8} md={10} >
            ...
            .map((info,i) => (
              (i!==index) ?
              <div className="d-flex align-items-center" key={info._id}>
                <div>
                    ...
                    <Card.Body>
                      <div className="d-flex">
                        ...
                        >
                          ...
                          <Button
                            variant="danger"
                            onClick={(e) => RemoveBook(info.bookId._id, info.action)}
