          ...
          <div class="col" key={ebook._id} style={{ marginBottom:"3rem" }}>
            ...
            <a className="viewlink" href={"/view/" + ebook._id}>
                ...
                <Card.Body>
                  ...
                  <div className="row">
                    <Button className="col" onClick={this.buy.bind(this, ebook._id)} style={{marginTop: "5%",marginRight:"1rem"}} variant="secondary">Buy</Button>
                    <Button className="col custom-button" onClick={this.showCartModal.bind(this, ebook._id, ebook.price, ebook.actions)} style={{marginTop: "5%"}} variant="secondary">Add to Cart</Button>
                  </div>
                </Card.Body>
            </Card>
          </div>
